...
def check_age (num_junior):
    ...
    for i in range(0):
        ...
        while flag:
            age = str(input('Please enter the age for junior ticket {} : '.format(i)))
            ...
            try:
                ...
                if int(age) < 16:
                   # not_junior = not_junior + 1
                    ...
                    print("Sorry, you have entered an age that is 16 and over. This ticket has been changed to an adult ticket.")
                    not_junior = not_junior + 1  
                    flag = False
